...
public class IntegritySCMLabelNotifierStep extends Notifier implements SimpleBuildStep
{
  ...
  public IntegritySCMLabelNotifierStep(IntegrityConfigurable ciSettings, String configPath,
      ...
      throws InterruptedException, IOException
  {
    ...
    try
    {
      ...
      IAPICommand command =
          CommandFactory.createCommand(IAPICommand.ADD_PROJECT_LABEL_COMMAND, ciSettings);
