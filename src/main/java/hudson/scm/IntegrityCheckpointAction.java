...
*/
      ...
      throws InterruptedException, IOException
  {
    ...
    {
      listener.getLogger().println("Build failed!  Skipping PTC RV&S Checkpoint step!");
      return true;
    }
    ...
    try
    {
      ...
      {
        LOGGER.severe("Cannot find PTC RV&S CM Project information for configuration '"
            + getConfigurationName() + "'");
        listener.getLogger()
            .println("ERROR: Cannot find PTC RV&S CM Project information for configuration '"
                + getConfigurationName() + "'!");
      }
